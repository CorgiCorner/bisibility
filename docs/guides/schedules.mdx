...
upcoming runs that you can review in **Runs** before they start. Runs includes
all executions, with **Upcoming**, **Active**, **Needs attention**, and **Finished**
filters. The **Schedules** tab is where you create, edit, or pause the recurring
rules and see their next execution times.

## Create a schedule

Open **Runs**, then the **Schedules** tab, and select **New schedule**. Give
...
Use **Skip once** in **Runs** with the **Upcoming** filter when you only want to cancel one
future occurrence. It cancels that planned run and its queued targets without
pausing the schedule.

Use **Run now** in **Runs** with the **Upcoming** filter to bring one planned or blocked run
