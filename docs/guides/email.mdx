...
description: "Choose and configure Resend, Amazon SES, or an SMTP relay for transactional email."
---
...
[file a feature spec](https://github.com/CorgiCorner/bisibility/issues/new?template=feature_spec.yml)
