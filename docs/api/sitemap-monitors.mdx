...
- [`GET /projects/{project_id}/sitemap-monitors`](/api-reference/sitemap-monitoring/get-sitemap-monitor-status) (`listSitemapMonitors`)
- [`PATCH /projects/{project_id}/sitemap-monitors/{monitor_id}`](/api-reference/sitemap-monitoring/update-sitemap-monitor) (`updateSitemapMonitor`)
