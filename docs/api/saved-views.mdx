...
- [`GET /projects/{project_id}/saved-views`](/api-reference/saved-views/list-saved-views) (`listSavedViews`)
- [`POST /projects/{project_id}/saved-views`](/api-reference/saved-views/create-a-saved-view) (`createSavedView`)
- [`DELETE /projects/{project_id}/saved-views/{view_id}`](/api-reference/saved-views/delete-a-project-saved-view) (`deleteProjectSavedView`)
- [`DELETE /saved-views/{view_id}`](/api-reference/saved-views/delete-a-saved-view-by-id) (`deleteSavedView`)
