...
- [`GET /projects/{project_id}/signals`](/api-reference/signals/list-project-signals) (`listSignals`)
- [`POST /signals`](/api-reference/signals/ingest-a-project-signal) (`createSignal`)
