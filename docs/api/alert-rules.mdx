...
- [`GET /projects/{project_id}/alert-rules`](/api-reference/alerts/list-alert-rules) (`listAlertRules`)
- [`POST /projects/{project_id}/alert-rules`](/api-reference/alerts/create-an-alert-rule) (`createAlertRule`)
- [`PATCH /alert-rules/{rule_id}`](/api-reference/alerts/update-an-alert-rule) (`updateAlertRule`)
- [`DELETE /alert-rules/{rule_id}`](/api-reference/alerts/delete-an-alert-rule) (`deleteAlertRule`)
- [`GET /projects/{project_id}/triggered-alerts`](/api-reference/alerts/list-triggered-alerts) (`listTriggeredAlerts`)
- [`POST /projects/{project_id}/triggered-alerts/{alert_id}/mute`](/api-reference/alerts/mute-one-triggered-alert-for-24-hours) (`muteTriggeredAlert`)
- [`POST /projects/{project_id}/triggered-alerts/mark-read`](/api-reference/alerts/mark-all-firing-project-alerts-as-read) (`markProjectAlertsRead`)
