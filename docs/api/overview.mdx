...
for credential types and the PAT selector precedence contract.
...
before version negotiation was added. Application releases, this API version,
and client package versions are independent; see
...
- [Import instance data](/api/cloud-import)
