...
Returns the shared anonymous usage and cost estimate used by onboarding and the
rank-tracking calculator. It accepts keyword count, market count (`locations` for
...
```http
GET /api/v1/cost-estimate?keywords=1&locations=1&devices=1&frequency=daily&depth=20&provider=dataforseo&option=live
```
...
- [`GET /capabilities`](/api-reference/discovery/get-api-capabilities) (`getCapabilities`)
- [`GET /cost-estimate`](/api-reference/discovery/estimate-monthly-serp-provider-cost) (`getCostEstimate`)
- [`GET /health`](/api-reference/discovery/check-api-health) (`getHealth`)
- [`GET /liveness`](/api-reference/discovery/check-web-process-liveness) (`getLiveness`)
- [`GET /llms.txt`](/api-reference/discovery/get-api-documentation-for-llms) (`getLlmsTxt`)
- [`GET /openapi.json`](/api-reference/discovery/get-the-openapi-document) (`getOpenApi`)
- [`GET /provider-rates`](/api-reference/discovery/list-public-serp-provider-rate-cards) (`getProviderRates`)
- [`GET /readiness`](/api-reference/discovery/check-web-traffic-readiness) (`getReadiness`)
