...
- [`GET /projects/{project_id}/analytics/query-stats`](/api-reference/analytics/list-search-query-statistics) (`listSearchPerformanceQueryStats`)
- [`POST /projects/{project_id}/analytics/sync`](/api-reference/analytics/sync-analytics-traffic) (`syncProjectTraffic`)
- [`GET /projects/{project_id}/analytics/traffic-snapshots`](/api-reference/analytics/list-stored-page-traffic-snapshots) (`listTrafficSnapshots`)
