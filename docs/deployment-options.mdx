...
| - | - | - |
| Hosted beta | You want the service operated for you and will connect your own data providers | [Hosted quickstart](/hosted-quickstart) |
| Local seeded demo | You want a throwaway evaluation with synthetic data and no provider account | [Local demo quickstart](/quickstart) |
...
[local demo quickstart](/quickstart) or the
[local Compose demo](/self-hosting/docker#local-demo), and never expose it on a
public address.
