...
description: "One-time source upgrade procedure from bisibility v0.1.0 to v0.2.0."
---
...
[distribution manifest](/self-hosting/upgrades#upgrade-with-a-distribution-manifest).
