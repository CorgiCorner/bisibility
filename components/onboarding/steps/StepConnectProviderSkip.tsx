  ...
  return (
    <>
      <div className="mt-4 text-xs text-fg-faint">
        ...
        {onSkip ? (
          <button
            className="cursor-pointer border-0 bg-transparent p-0 font-semibold text-accent hover:underline"
          ...
          <Link className="font-semibold text-accent hover:underline" href={skipHref}>
            Skip, add keywords as paused
          </Link>
        )}
        .
