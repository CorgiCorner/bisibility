import type { VerificationCodeForm } from "@/components/settings/notifications/notification-email-form";
import { SettingsField } from "@/components/settings/shell/settings-field-widths";
import { Button, FieldLabel, Input } from "@/components/ui";
import type { FieldError, UseFormRegister } from "react-hook-form";

type NotificationEmailConfirmationProps = {
  canConfirm: boolean;
...
export function NotificationEmailConfirmation({
  canConfirm,
  codeError,
  confirming,
  description,
  ...
  register,
  sendingCode,
}: Readonly<NotificationEmailConfirmationProps>) {
  return (
      ...
      <SettingsField width="field">
        ...
        <div className="mt-1.5 flex flex-wrap items-start gap-2">
          <div className="min-w-[180px] flex-1">
            <Input
              aria-describedby="notification-email-code-error"
            ...
            {codeError ? (
              <p
                ...
                id="notification-email-code-error"
                role="alert"
              >
                {codeError.message}
              </p>
