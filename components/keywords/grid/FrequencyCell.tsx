...
export function FrequencyCell({ row }: Readonly<Pick<GridRenderCellParams<KeywordRow>, "row">>) {
  return (
    <span className="inline-flex min-w-0 items-center gap-1.5 whitespace-nowrap">
      ...
      <span className="inline-flex h-5 shrink-0 self-center items-center whitespace-nowrap rounded-full border border-border bg-bg-sunken px-2 font-sans tabular-nums text-[9.5px] font-semibold uppercase leading-none tracking-[0.4px] text-fg-muted">
