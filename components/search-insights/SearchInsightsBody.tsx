...
export function SearchInsightsBody({
  ...
  const firstViewReady = importState?.firstViewReady === true;
  ...
  return (
    <div className="flex min-w-0 flex-col gap-2.5">
      <SearchInsightsKpiRow extra={view.sessionsKpi} kpis={view.kpis} />
      <SearchInsightsSignalChips
        ga4Card={
          ga4Card ??
          (sessionsConnected ? null : <SearchInsightsSessionsCard projectId={projectId} />)
        }
        onOpenBand={
