...
const keywords: KeywordFixture[] = [
  ...
  { id: 3, keyword: "react data grid", position: 6, previousPosition: 4, url: "/docs/data-grid" },
  { id: 4, keyword: "self hosted seo tool", position: 2, previousPosition: 7, url: "/self-host" },
  ...
  { id: 7, keyword: "serp api alternative", position: 5, previousPosition: 9, url: "/vs/serpapi" },
  {
    id: 8,
